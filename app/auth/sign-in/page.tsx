    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-16">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-32 right-10 h-72 w-72 rounded-full bg-violet-600/20 blur-3xl" />
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          >
            <div className="mb-6 space-y-2 text-center">
              ...
              <p className="text-sm text-white/70">Welcome back. Continue to your dashboard.</p>
            </div>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-xs">
                <span className="text-white/60">Sessions are remembered automatically.</span>
                <Link href="/auth/reset-password" className="text-violet-300 hover:text-violet-200">
                  Forgot password?
                </Link>
              </div>
