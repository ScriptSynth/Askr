...
export async function generateMetadata({ 
  ...
  const page = useCases.find(p => p.slug === slug)
  ...
  return {
    ...
    alternates: {
      canonical: `https://askr.io/use-cases/${slug}`,
    },
  }
}
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-violet-50/70 via-background to-blue-50/40">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-violet-100/70 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="container flex h-16 items-center mx-auto px-4 md:px-6">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            ...
            <Link href="/use-cases/collect-testimonials" className="transition-all hover:text-violet-600 text-violet-600 font-semibold">Use Cases</Link>
      ...
      <main className="relative container mx-auto px-4 md:px-6 py-16 md:py-24">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <h2 className="text-2xl font-bold text-center mb-8">Why Choose Askr for This</h2>
        ...
        {/* Features */}
        <div className="max-w-5xl mx-auto mb-16">
          <h2 className="text-2xl font-bold text-center mb-8">Features You'll Love</h2>
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Trusted by <strong className="text-foreground">500+ companies</strong> to collect and display testimonials
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-center rounded-2xl border border-violet-100/70 bg-white/75 backdrop-blur-xl p-8 md:p-12 shadow-xl">
          ...
          <p className="text-muted-foreground mb-6">
            Join hundreds of companies using Askr. Free to start, no credit card required.
          </p>
          <Link href="/auth">
        ...
        <div className="max-w-5xl mx-auto mt-16">
          <h2 className="text-xl font-bold mb-6">Other Use Cases</h2>
          <div className="grid md:grid-cols-3 gap-4">
            {useCases.filter(p => p.slug !== slug).slice(0, 3).map((related) => (
              <Link key={related.slug} href={`/use-cases/${related.slug}`} className="group">
